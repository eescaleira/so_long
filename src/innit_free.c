...
/*   Updated: 2023/12/30 18:14:13 by eescalei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->mlx = mlx_init();
	data->mlx_win = mlx_new_window(data->mlx, data->map->width * 32, data->map->height * 32, "first window");
}
...
int destroy_window(t_mlx_data *data)
{
	...
	if((data->mlx_win != NULL) || (data->mlx != NULL)) 
	{	
